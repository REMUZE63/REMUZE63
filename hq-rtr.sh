...
network 192.168.14.0/27 area 0
network 192.168.14.64/28 area 0
network 192.168.14.80/29 area 0
...
ip nat outside
exit
ip nat pool NAT_POOL 192.168.14.1-192.168.14.30,192.168.14.65-192.168.14.78,192.168.14.81-192.168.14.87
ip nat source dynamic inside-to-outside pool NAT_POOL overload interface int0
ip pool cli_pool 1 
range 192.168.14.66-192.168.14.78
exit
dhcp-server 1
pool cli_pool 1
mask 255.255.255.240
gateway 192.168.14.65
dns 192.168.100.62
